...
class DetailViewModel: ObservableObject {
	...
	private func mapDataToStatistics(coinDetailModel:CoinDetailModel?, coinModel:CoinModel) -> (overview: [StatisticModel] , additional: [StatisticModel]) {
		...
		var overviewArray: [StatisticModel] = [priceStat, marketCapStats,rankStat,volumeStat]
		...
		let marketCapChangeStats = StatisticModel(title: "Market Capitalization", value: marketCapChange, percentageChange: marketCapPercentChange2)
		...
		let additionalArray: [StatisticModel] = [highStat, loeStat,priceChangeStat,marketCapChangeStats,blockStat,hashingStat]
